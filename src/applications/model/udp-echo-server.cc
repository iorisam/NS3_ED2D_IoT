...
void UdpEchoServer::SetHelper(Ptr<NistLteProseHelper> Helper){
...
//      Ptr<NetDevice> iFace1 =GetNode()->GetDevice(0);
//      uint32_t groupL2Address = 0xFF;
//      Ptr<NistSlTft> tft = Create<NistSlTft> (NistSlTft::BIDIRECTIONAL,InetSocketAddress::ConvertFrom (from).GetIpv4 (), groupL2Address);
//      m_proseHelper->ActivateSidelinkBearer(Seconds(Simulator::Now ().GetSeconds ()),iFace1,tft);
