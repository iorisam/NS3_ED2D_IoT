 ...
 */
class LteAppServerHelper
{
public:
  /**
   * Create LteAppServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  LteAppServerHelper (uint16_t port);
 ...
 */
class LteAppClientHelper
{
public:
  /**
   * Create LteAppClientHelper which will make life easier for people trying
   ...
   */
  LteAppClientHelper (Address ip, uint16_t port);
  /**
   * Create LteAppClientHelper which will make life easier for people trying
   * to set up simulations with echos. Use this variant with addresses that do
   ...
   */
  LteAppClientHelper (Address addr);
