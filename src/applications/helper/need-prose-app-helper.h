...
#ifndef NEED_PROSE_APP_HELPER_H
#define NEED_PROSE_APP_HELPER_H
...
public:
   ...
   */
	NeedProSeAppHelper (uint16_t port);
	...
	/**
	   ...
	   */
	NeedProSeAppHelper (Address ip, uint16_t port);
	  /**
	   * Create RequestResponseClientHelper which will make life easier for people trying
	   * to set up simulations with echos. Use this variant with addresses that do
	   ...
	   */
	NeedProSeAppHelper (Address addr);
