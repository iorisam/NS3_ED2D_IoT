 ...
 */
#ifndef LTE_ECHO_HELPER_H
#define LTE_ECHO_HELPER_H
 ...
 */
class lte_echo_server_helper
{
public:
  /**
   * Create lte_echo_server_helper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  lte_echo_server_helper (uint16_t port);
  ...
  void SetIfIndex (uint16_t index);
 ...
 */
class lte_echo_client_helper
{
public:
  /**
   * Create lte_echo_client_helper which will make life easier for people trying
   ...
   */
  lte_echo_client_helper (Address ip, uint16_t port);
  /**
   * Create lte_echo_client_helper which will make life easier for people trying
   * to set up simulations with echos. Use this variant with addresses that do
   ...
   */
  lte_echo_client_helper (Address addr);
