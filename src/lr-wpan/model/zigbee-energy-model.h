...
#ifndef ZIGBEE_ENERGY_MODEL_H
#define ZIGBEE_ENERGY_MODEL_H
...
class ZigbeeEnergyModel : public DeviceEnergyModel
{
public:
  /**
   * Callback type for energy depletion handling.
   */
  typedef Callback<void> ZigbeeEnergyDepletionCallback;

public:
  static TypeId GetTypeId (void);
  ZigbeeEnergyModel ();
  virtual ~ZigbeeEnergyModel ();
   ...
   */
  void SetEnergyDepletionCallback (ZigbeeEnergyDepletionCallback callback);
...
private:
  ...
  ZigbeeEnergyDepletionCallback m_energyDepletionCallback;
