...
public:
  ...
  //discovery
  virtual void StartDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx);
  virtual void StopDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx);
