...
NistPointToPointEpcHelper::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistPointToPointEpcHelper")
    ...
    .AddAttribute ("X2LinkDataRate",
                   ...
                   DataRateValue (DataRate ("10Gb/s")),
                   MakeDataRateAccessor (&NistPointToPointEpcHelper::m_x2LinkDataRate),
                   MakeDataRateChecker ())
    .AddAttribute ("X2LinkDelay",
                   "The delay to be used for the next X2 link to be created",
                   TimeValue (Seconds (0)),
                   MakeTimeAccessor (&NistPointToPointEpcHelper::m_x2LinkDelay),
                   MakeTimeChecker ())
    .AddAttribute ("X2LinkMtu",
                   ...
                   UintegerValue (3000),
                   MakeUintegerAccessor (&NistPointToPointEpcHelper::m_x2LinkMtu),
                   MakeUintegerChecker<uint16_t> ())
  ;
  return tid;
}
...
void
NistPointToPointEpcHelper::AddEnb (Ptr<Node> enb, Ptr<NetDevice> lteEnbNetDevice, uint16_t cellId)
{
...
void
NistPointToPointEpcHelper::AddX2Interface (Ptr<Node> enb1, Ptr<Node> enb2)
{
...
void
NistPointToPointEpcHelper::StartDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx)
{
  NS_LOG_FUNCTION (this << ueDevice);
...
void
NistPointToPointEpcHelper::StopDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx)
{
  NS_LOG_FUNCTION (this << ueDevice);
