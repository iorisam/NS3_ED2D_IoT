...
public:
   ...
   */
  virtual void StartDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx) = 0;
   ...
   *  \param rxtx the interest in monitoring or announcing (0 for rx and 1 for tx)
   */
  virtual void StopDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx) = 0;
