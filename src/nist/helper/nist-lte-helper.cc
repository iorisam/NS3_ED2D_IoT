...
NistLteHelper::InstallSingleUeDevice (Ptr<Node> n)
{
  ...
  EnergyModuleLte *ref = &mac->LEM;
  EnergySourcesContainer.insert(std::pair<int , EnergyModuleLte*>(n->GetId(),ref));
...
NistLteHelper::Attach (Ptr<NetDevice> ueDevice)
{
  ...
  std::cout<<"here please inside the helper"<<std::endl;
...
void
NistLteHelper::StartDiscovery (NetDeviceContainer ueDevices, std::list<std::string> apps, bool rxtx)
{
  NS_LOG_FUNCTION (this);
  for (NetDeviceContainer::Iterator i = ueDevices.Begin (); i != ueDevices.End (); ++i)
    {
...
void
NistLteHelper::StartDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx)
{
  NS_LOG_FUNCTION (this);
...
void
NistLteHelper::StopDiscovery (NetDeviceContainer ueDevices, std::list<std::string> apps, bool rxtx)
{
  NS_LOG_FUNCTION (this);
  for (NetDeviceContainer::Iterator i = ueDevices.Begin (); i != ueDevices.End (); ++i)
    {
...
void
NistLteHelper::StopDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx)
{
  NS_LOG_FUNCTION (this);
...
NistLteHelper::EnableTraces (void)
{
  ...
  std::cout<<"we are out of the function EnableTraces"<<std::endl;
}
...
NistLteHelper::EnableSlSchUeMacTraces (void)
{
  ...
  std::cout<<"we are out of the function EnableSlSchUeMacTraces "<<std::endl;
}
