...
public:
 ...
 /**
   ...
   */
  void StartDiscovery (NetDeviceContainer ueDevices, std::list<std::string> apps, bool rxtx);
   ...
   * \param rxtx the interest in monitoring or announcing (0 for rx and 1 for tx)
   */
  void StopDiscovery (NetDeviceContainer ueDevices, std::list<std::string> apps, bool rxtx);
   ...
   * \param rxtx the interest in monitoring or announcing (0 for rx and 1 for tx)
   */
  void StartDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx);
   ...
   *  \param rxtx the interest in monitoring or announcing (0 for rx and 1 for tx)
   */
  void StopDiscovery (Ptr<NetDevice> ueDevice, std::list<std::string> apps, bool rxtx);
...
public : std::map<int,EnergyModuleLte*> EnergySourcesContainer;
