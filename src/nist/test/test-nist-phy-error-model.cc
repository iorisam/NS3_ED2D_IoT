...
{
public:
  static std::string BuildNameString (NistLtePhyErrorModel::NistLtePhyChannel channel, NistLtePhyErrorModel::NistLteFadingModel fadingChannel, NistLtePhyErrorModel::NistLteTxMode txmode, uint16_t mcs, double newSinr, Nist_HarqProcessInfoList_t harqHistory);
  NistLtePhyErrorModelTestCase (NistLtePhyErrorModel::NistLtePhyChannel channel, NistLtePhyErrorModel::NistLteFadingModel fadingChannel, NistLtePhyErrorModel::NistLteTxMode txmode, uint16_t mcs, double newSinr, Nist_HarqProcessInfoList_t harqHistory, double expectedBler, NistPhyErrorModelTestCondition cond);
...
private:
  ...
  uint16_t m_mcs;
  double m_newSinr; 
  Nist_HarqProcessInfoList_t m_harqHistory;
  double m_expectedBler;
  NistPhyErrorModelTestCondition m_cond;
};

std::string NistLtePhyErrorModelTestCase::BuildNameString (NistLtePhyErrorModel::NistLtePhyChannel channel, NistLtePhyErrorModel::NistLteFadingModel fadingChannel, NistLtePhyErrorModel::NistLteTxMode txmode, uint16_t mcs, double newSinr, Nist_HarqProcessInfoList_t harqHistory)
{
...
NistLtePhyErrorModelTestCase::NistLtePhyErrorModelTestCase (NistLtePhyErrorModel::NistLtePhyChannel channel, NistLtePhyErrorModel::NistLteFadingModel fadingChannel, NistLtePhyErrorModel::NistLteTxMode txmode, uint16_t mcs, double newSinr, Nist_HarqProcessInfoList_t harqHistory, double expectedBler, NistPhyErrorModelTestCondition cond)
