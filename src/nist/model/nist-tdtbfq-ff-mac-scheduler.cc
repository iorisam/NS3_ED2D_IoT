...
#include <ns3/nist-tdtbfq-ff-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("NistTdTbfqFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (NistTdTbfqFfMacScheduler);



class NistTdTbfqSchedulerMemberCschedSapProvider : public NistFfMacCschedSapProvider
{
public:
  NistTdTbfqSchedulerMemberCschedSapProvider (NistTdTbfqFfMacScheduler* scheduler);
...
private:
  NistTdTbfqSchedulerMemberCschedSapProvider ();
  NistTdTbfqFfMacScheduler* m_scheduler;
};

NistTdTbfqSchedulerMemberCschedSapProvider::NistTdTbfqSchedulerMemberCschedSapProvider ()
{
}

NistTdTbfqSchedulerMemberCschedSapProvider::NistTdTbfqSchedulerMemberCschedSapProvider (NistTdTbfqFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
NistTdTbfqSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct NistCschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
NistTdTbfqSchedulerMemberCschedSapProvider::CschedNistUeConfigReq (const struct NistCschedNistUeConfigReqParameters& params)
{
...
void
NistTdTbfqSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct NistCschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
NistTdTbfqSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct NistCschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
NistTdTbfqSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct NistCschedUeReleaseReqParameters& params)
{
...
class NistTdTbfqSchedulerMemberSchedSapProvider : public NistFfMacSchedSapProvider
{
public:
  NistTdTbfqSchedulerMemberSchedSapProvider (NistTdTbfqFfMacScheduler* scheduler);
...
private:
  NistTdTbfqSchedulerMemberSchedSapProvider ();
  NistTdTbfqFfMacScheduler* m_scheduler;
};



NistTdTbfqSchedulerMemberSchedSapProvider::NistTdTbfqSchedulerMemberSchedSapProvider ()
{
}


NistTdTbfqSchedulerMemberSchedSapProvider::NistTdTbfqSchedulerMemberSchedSapProvider (NistTdTbfqFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct NistSchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct NistSchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct NistSchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct NistSchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct NistSchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct NistSchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct NistSchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct NistSchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct NistSchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct NistSchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
NistTdTbfqSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct NistSchedUlCqiInfoReqParameters& params)
{
...
NistTdTbfqFfMacScheduler::NistTdTbfqFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiUl (0),
    bankSize (0)
{
  ...
  m_cschedSapProvider = new NistTdTbfqSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new NistTdTbfqSchedulerMemberSchedSapProvider (this);
  m_ffrSapProvider = 0;
  m_ffrSapUser = new MemberNistLteFfrSapUser<NistTdTbfqFfMacScheduler> (this);
}
...
void
NistTdTbfqFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NistTdTbfqFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistTdTbfqFfMacScheduler")
    .SetParent<NistFfMacScheduler> ()
    .AddConstructor<NistTdTbfqFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&NistTdTbfqFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("DebtLimit",
                   "Flow debt limit (default -625000 bytes)",
                   IntegerValue (-625000),
                   MakeIntegerAccessor (&NistTdTbfqFfMacScheduler::m_debtLimit),
                   MakeIntegerChecker<int> ())
    .AddAttribute ("CreditLimit",
                   "Flow credit limit (default 625000 bytes)",
                   UintegerValue (625000),
                   MakeUintegerAccessor (&NistTdTbfqFfMacScheduler::m_creditLimit),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("TokenPoolSize",
                   "The maximum value of flow token pool (default 1 bytes)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&NistTdTbfqFfMacScheduler::m_tokenPoolSize),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("CreditableThreshold",
                   "Threshold of flow credit (default 0 bytes)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistTdTbfqFfMacScheduler::m_creditableThreshold),
                   MakeUintegerChecker<uint32_t> ())

    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&NistTdTbfqFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistTdTbfqFfMacScheduler::m_ulGrantMcs),
...
void
NistTdTbfqFfMacScheduler::SetNistFfMacCschedSapUser (NistFfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
NistTdTbfqFfMacScheduler::SetNistFfMacSchedSapUser (NistFfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

NistFfMacCschedSapProvider*
NistTdTbfqFfMacScheduler::GetNistFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

NistFfMacSchedSapProvider*
NistTdTbfqFfMacScheduler::GetNistFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
NistTdTbfqFfMacScheduler::SetNistLteFfrSapProvider (NistLteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NistLteFfrSapUser*
NistTdTbfqFfMacScheduler::GetNistLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
NistTdTbfqFfMacScheduler::DoCschedCellConfigReq (const struct NistFfMacCschedSapProvider::NistCschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistTdTbfqFfMacScheduler::DoCschedNistUeConfigReq (const struct NistFfMacCschedSapProvider::NistCschedNistUeConfigReqParameters& params)
{
...
void
NistTdTbfqFfMacScheduler::DoCschedLcConfigReq (const struct NistFfMacCschedSapProvider::NistCschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this << " New LC, rnti: "  << params.m_rnti);

  std::map <uint16_t, NisttdtbfqsFlowPerf_t>::iterator it;
      ...
      if (it == m_flowStatsDl.end ())
        {
          ...
          NisttdtbfqsFlowPerf_t flowStatsDl;
          ...
          m_flowStatsDl.insert (std::pair<uint16_t, NisttdtbfqsFlowPerf_t> (params.m_rnti, flowStatsDl));
          NisttdtbfqsFlowPerf_t flowStatsUl;
          ...
          m_flowStatsUl.insert (std::pair<uint16_t, NisttdtbfqsFlowPerf_t> (params.m_rnti, flowStatsUl));
        }
      else
        {
...
void
NistTdTbfqFfMacScheduler::DoCschedLcReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistTdTbfqFfMacScheduler::DoCschedUeReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistTdTbfqFfMacScheduler::DoSchedDlRlcBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters& params)
{
...
void
NistTdTbfqFfMacScheduler::DoSchedDlPagingBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistTdTbfqFfMacScheduler::DoSchedDlMacBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
NistTdTbfqFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
int
NistTdTbfqFfMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
...
uint8_t
NistTdTbfqFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
NistTdTbfqFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
NistTdTbfqFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
NistTdTbfqFfMacScheduler::DoSchedDlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedDlTriggerReqParameters& params)
{
  ...
  std::map <uint16_t, NisttdtbfqsFlowPerf_t>::iterator itStats;
  ...
  std::map <uint16_t, NisttdtbfqsFlowPerf_t>::iterator it;
  std::map <uint16_t, NisttdtbfqsFlowPerf_t>::iterator itMax = m_flowStatsDl.end ();
...
void
NistTdTbfqFfMacScheduler::DoSchedDlRachInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistTdTbfqFfMacScheduler::DoSchedDlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
NistTdTbfqFfMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
NistTdTbfqFfMacScheduler::DoSchedUlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedUlTriggerReqParameters& params)
{
...
void
NistTdTbfqFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct NistFfMacSchedSapProvider::NistSchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistTdTbfqFfMacScheduler::DoSchedUlSrInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistTdTbfqFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistTdTbfqFfMacScheduler::DoSchedUlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
// retrieve the allocation for this subframe
  ...
  switch (params.m_ulCqi.m_type)
    ...
    case NistUlCqi_s::PRACH:
      {
        NS_FATAL_ERROR ("NistTdTbfqFfMacScheduler supports only PUSCH and SRS UL-CQIs");
      }
      break;
    default:
...
void
NistTdTbfqFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
NistTdTbfqFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
NistTdTbfqFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
...
void
NistTdTbfqFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
NistTdTbfqFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
