...
#include <ns3/nist-fdtbfq-ff-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("NistFdTbfqNistFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (NistFdTbfqNistFfMacScheduler);



class NistFdTbfqSchedulerMemberCschedSapProvider : public NistFfMacCschedSapProvider
{
public:
  NistFdTbfqSchedulerMemberCschedSapProvider (NistFdTbfqNistFfMacScheduler* scheduler);
...
private:
  NistFdTbfqSchedulerMemberCschedSapProvider ();
  NistFdTbfqNistFfMacScheduler* m_scheduler;
};

NistFdTbfqSchedulerMemberCschedSapProvider::NistFdTbfqSchedulerMemberCschedSapProvider ()
{
}

NistFdTbfqSchedulerMemberCschedSapProvider::NistFdTbfqSchedulerMemberCschedSapProvider (NistFdTbfqNistFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
NistFdTbfqSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct NistCschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
NistFdTbfqSchedulerMemberCschedSapProvider::CschedNistUeConfigReq (const struct NistCschedNistUeConfigReqParameters& params)
{
...
void
NistFdTbfqSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct NistCschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
NistFdTbfqSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct NistCschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
NistFdTbfqSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct NistCschedUeReleaseReqParameters& params)
{
...
class NistFdTbfqSchedulerMemberSchedSapProvider : public NistFfMacSchedSapProvider
{
public:
  NistFdTbfqSchedulerMemberSchedSapProvider (NistFdTbfqNistFfMacScheduler* scheduler);
...
private:
  NistFdTbfqSchedulerMemberSchedSapProvider ();
  NistFdTbfqNistFfMacScheduler* m_scheduler;
};



NistFdTbfqSchedulerMemberSchedSapProvider::NistFdTbfqSchedulerMemberSchedSapProvider ()
{
}


NistFdTbfqSchedulerMemberSchedSapProvider::NistFdTbfqSchedulerMemberSchedSapProvider (NistFdTbfqNistFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct NistSchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct NistSchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct NistSchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct NistSchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct NistSchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct NistSchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct NistSchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct NistSchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct NistSchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct NistSchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
NistFdTbfqSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct NistSchedUlCqiInfoReqParameters& params)
{
...
NistFdTbfqNistFfMacScheduler::NistFdTbfqNistFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiUl (0),
    bankSize (0)
{
  ...
  m_cschedSapProvider = new NistFdTbfqSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new NistFdTbfqSchedulerMemberSchedSapProvider (this);
  m_ffrSapProvider = 0;
  m_ffrSapUser = new MemberNistLteFfrSapUser<NistFdTbfqNistFfMacScheduler> (this);
}
...
void
NistFdTbfqNistFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NistFdTbfqNistFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistFdTbfqNistFfMacScheduler")
    .SetParent<NistFfMacScheduler> ()
    .AddConstructor<NistFdTbfqNistFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&NistFdTbfqNistFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("DebtLimit",
                   "Flow debt limit (default -625000 bytes)",
                   IntegerValue (-625000),
                   MakeIntegerAccessor (&NistFdTbfqNistFfMacScheduler::m_debtLimit),
                   MakeIntegerChecker<int> ())
    .AddAttribute ("CreditLimit",
                   "Flow credit limit (default 625000 bytes)",
                   UintegerValue (625000),
                   MakeUintegerAccessor (&NistFdTbfqNistFfMacScheduler::m_creditLimit),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("TokenPoolSize",
                   "The maximum value of flow token pool (default 1 bytes)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&NistFdTbfqNistFfMacScheduler::m_tokenPoolSize),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("CreditableThreshold",
                   "Threshold of flow credit (default 0 bytes)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistFdTbfqNistFfMacScheduler::m_creditableThreshold),
                   MakeUintegerChecker<uint32_t> ())

    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&NistFdTbfqNistFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistFdTbfqNistFfMacScheduler::m_ulGrantMcs),
...
void
NistFdTbfqNistFfMacScheduler::SetNistFfMacCschedSapUser (NistFfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
NistFdTbfqNistFfMacScheduler::SetNistFfMacSchedSapUser (NistFfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

NistFfMacCschedSapProvider*
NistFdTbfqNistFfMacScheduler::GetNistFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

NistFfMacSchedSapProvider*
NistFdTbfqNistFfMacScheduler::GetNistFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
NistFdTbfqNistFfMacScheduler::SetNistLteFfrSapProvider (NistLteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NistLteFfrSapUser*
NistFdTbfqNistFfMacScheduler::GetNistLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
NistFdTbfqNistFfMacScheduler::DoCschedCellConfigReq (const struct NistFfMacCschedSapProvider::NistCschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdTbfqNistFfMacScheduler::DoCschedNistUeConfigReq (const struct NistFfMacCschedSapProvider::NistCschedNistUeConfigReqParameters& params)
{
...
void
NistFdTbfqNistFfMacScheduler::DoCschedLcConfigReq (const struct NistFfMacCschedSapProvider::NistCschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this << " New LC, rnti: "  << params.m_rnti);

  std::map <uint16_t, NistfdtbfqsFlowPerf_t>::iterator it;
      ...
      if (it == m_flowStatsDl.end ())
        {
          ...
          NistfdtbfqsFlowPerf_t flowStatsDl;
          ...
          m_flowStatsDl.insert (std::pair<uint16_t, NistfdtbfqsFlowPerf_t> (params.m_rnti, flowStatsDl));
          NistfdtbfqsFlowPerf_t flowStatsUl;
          ...
          m_flowStatsUl.insert (std::pair<uint16_t, NistfdtbfqsFlowPerf_t> (params.m_rnti, flowStatsUl));
        }
      else
        {
          // update MBR and GBR from NistUeManager::SetupDataRadioBearer ()
          uint64_t mbrDlInBytes = params.m_logicalChannelConfigList.at (i).m_eRabMaximulBitrateDl / 8;   // byte/s
          uint64_t mbrUlInBytes = params.m_logicalChannelConfigList.at (i).m_eRabMaximulBitrateUl / 8;   // byte/s
...
void
NistFdTbfqNistFfMacScheduler::DoCschedLcReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdTbfqNistFfMacScheduler::DoCschedUeReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdTbfqNistFfMacScheduler::DoSchedDlRlcBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters& params)
{
...
void
NistFdTbfqNistFfMacScheduler::DoSchedDlPagingBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdTbfqNistFfMacScheduler::DoSchedDlMacBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
NistFdTbfqNistFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
int
NistFdTbfqNistFfMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
...
uint8_t
NistFdTbfqNistFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
NistFdTbfqNistFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
NistFdTbfqNistFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
NistFdTbfqNistFfMacScheduler::DoSchedDlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedDlTriggerReqParameters& params)
{
  ...
  std::map <uint16_t, NistfdtbfqsFlowPerf_t>::iterator itStats;
  ...
  while (totalRbg < rbgNum)
    {
      ...
      std::map <uint16_t, NistfdtbfqsFlowPerf_t>::iterator it;
      std::map <uint16_t, NistfdtbfqsFlowPerf_t>::iterator itMax = m_flowStatsDl.end ();
      ...
      if (budget == 0)
        ...
        {	
          ...
          uint8_t lcid = 0;
          std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itRlcBuf;
          ...
          NistLteFlowId_t flow ((*itMax).first, lcid);
          itRlcBuf = m_rlcBufferReq.find (flow);
          if (itRlcBuf!=m_rlcBufferReq.end ())
	          rlcBufSize = (*itRlcBuf).second.m_rlcTransmissionQueueSize + (*itRlcBuf).second.m_rlcRetransmissionQueueSize + (*itRlcBuf).second.m_rlcNistStatusPduSize;
...
void
NistFdTbfqNistFfMacScheduler::DoSchedDlRachInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdTbfqNistFfMacScheduler::DoSchedDlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
NistFdTbfqNistFfMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
NistFdTbfqNistFfMacScheduler::DoSchedUlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedUlTriggerReqParameters& params)
{
...
void
NistFdTbfqNistFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct NistFfMacSchedSapProvider::NistSchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistFdTbfqNistFfMacScheduler::DoSchedUlSrInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistFdTbfqNistFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdTbfqNistFfMacScheduler::DoSchedUlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
// retrieve the allocation for this subframe
  ...
  switch (params.m_ulCqi.m_type)
    ...
    case NistUlCqi_s::PRACH:
      {
        NS_FATAL_ERROR ("NistFdTbfqNistFfMacScheduler supports only PUSCH and SRS UL-CQIs");
      }
      break;
    default:
...
void
NistFdTbfqNistFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
NistFdTbfqNistFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
NistFdTbfqNistFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
...
void
NistFdTbfqNistFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
NistFdTbfqNistFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
