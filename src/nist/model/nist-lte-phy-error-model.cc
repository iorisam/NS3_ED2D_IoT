...
NistTbErrorStats_t
NistLtePhyErrorModel::GetPsschBler (NistLteFadingModel fadingChannel, NistLteTxMode txmode, uint16_t mcs, double sinr, Nist_HarqProcessInfoList_t harqHistory)
{
  //Check mcs values
  if (mcs > 20) 
    {
...
NistTbErrorStats_t
NistLtePhyErrorModel::GetPsdchBler (NistLteFadingModel fadingChannel, NistLteTxMode txmode, double sinr, Nist_HarqProcessInfoList_t harqHistory)
{
  //Find the table to use
  const double (*xtable)[XTABLE_SIZE];
  const double *ytable;
...
NistTbErrorStats_t
NistLtePhyErrorModel::GetPuschBler (NistLteFadingModel fadingChannel, NistLteTxMode txmode, uint16_t mcs, double sinr, Nist_HarqProcessInfoList_t harqHistory)
{
  //Check mcs values
  if (mcs > 28) 
    {
