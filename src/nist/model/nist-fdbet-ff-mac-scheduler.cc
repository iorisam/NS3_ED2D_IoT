...
#include <ns3/nist-fdbet-ff-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("NistFdBetNistFfMacScheduler");

static const int NistFdBetType0AllocationRbg[4] = {
  10,       // RGB size 1
  26,       // RGB size 2
  63,       // RGB size 3
  110       // RGB size 4
...
NS_OBJECT_ENSURE_REGISTERED (NistFdBetNistFfMacScheduler);



class NistFdBetSchedulerMemberCschedSapProvider : public NistFfMacCschedSapProvider
{
public:
  NistFdBetSchedulerMemberCschedSapProvider (NistFdBetNistFfMacScheduler* scheduler);
...
private:
  NistFdBetSchedulerMemberCschedSapProvider ();
  NistFdBetNistFfMacScheduler* m_scheduler;
};

NistFdBetSchedulerMemberCschedSapProvider::NistFdBetSchedulerMemberCschedSapProvider ()
{
}

NistFdBetSchedulerMemberCschedSapProvider::NistFdBetSchedulerMemberCschedSapProvider (NistFdBetNistFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
NistFdBetSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct NistCschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
NistFdBetSchedulerMemberCschedSapProvider::CschedNistUeConfigReq (const struct NistCschedNistUeConfigReqParameters& params)
{
...
void
NistFdBetSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct NistCschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
NistFdBetSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct NistCschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
NistFdBetSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct NistCschedUeReleaseReqParameters& params)
{
...
class NistFdBetSchedulerMemberSchedSapProvider : public NistFfMacSchedSapProvider
{
public:
  NistFdBetSchedulerMemberSchedSapProvider (NistFdBetNistFfMacScheduler* scheduler);
...
private:
  NistFdBetSchedulerMemberSchedSapProvider ();
  NistFdBetNistFfMacScheduler* m_scheduler;
};



NistFdBetSchedulerMemberSchedSapProvider::NistFdBetSchedulerMemberSchedSapProvider ()
{
}


NistFdBetSchedulerMemberSchedSapProvider::NistFdBetSchedulerMemberSchedSapProvider (NistFdBetNistFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct NistSchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct NistSchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct NistSchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct NistSchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct NistSchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct NistSchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct NistSchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct NistSchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct NistSchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct NistSchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
NistFdBetSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct NistSchedUlCqiInfoReqParameters& params)
{
...
NistFdBetNistFfMacScheduler::NistFdBetNistFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_timeWindow (99.0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new NistFdBetSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new NistFdBetSchedulerMemberSchedSapProvider (this);
}
...
void
NistFdBetNistFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NistFdBetNistFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistFdBetNistFfMacScheduler")
    .SetParent<NistFfMacScheduler> ()
    .AddConstructor<NistFdBetNistFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&NistFdBetNistFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&NistFdBetNistFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistFdBetNistFfMacScheduler::m_ulGrantMcs),
...
void
NistFdBetNistFfMacScheduler::SetNistFfMacCschedSapUser (NistFfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
NistFdBetNistFfMacScheduler::SetNistFfMacSchedSapUser (NistFfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

NistFfMacCschedSapProvider*
NistFdBetNistFfMacScheduler::GetNistFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

NistFfMacSchedSapProvider*
NistFdBetNistFfMacScheduler::GetNistFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
NistFdBetNistFfMacScheduler::SetNistLteFfrSapProvider (NistLteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NistLteFfrSapUser*
NistFdBetNistFfMacScheduler::GetNistLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
NistFdBetNistFfMacScheduler::DoCschedCellConfigReq (const struct NistFfMacCschedSapProvider::NistCschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdBetNistFfMacScheduler::DoCschedNistUeConfigReq (const struct NistFfMacCschedSapProvider::NistCschedNistUeConfigReqParameters& params)
{
...
void
NistFdBetNistFfMacScheduler::DoCschedLcConfigReq (const struct NistFfMacCschedSapProvider::NistCschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this << " New LC, rnti: "  << params.m_rnti);

  std::map <uint16_t, NistfdbetsFlowPerf_t>::iterator it;
  for (uint16_t i = 0; i < params.m_logicalChannelConfigList.size (); i++)
    {
      ...
      if (it == m_flowStatsDl.end ())
        {
          NistfdbetsFlowPerf_t flowStatsDl;
          ...
          m_flowStatsDl.insert (std::pair<uint16_t, NistfdbetsFlowPerf_t> (params.m_rnti, flowStatsDl));
          NistfdbetsFlowPerf_t flowStatsUl;
          ...
          m_flowStatsUl.insert (std::pair<uint16_t, NistfdbetsFlowPerf_t> (params.m_rnti, flowStatsUl));
        }
    }
...
void
NistFdBetNistFfMacScheduler::DoCschedLcReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdBetNistFfMacScheduler::DoCschedUeReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdBetNistFfMacScheduler::DoSchedDlRlcBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters& params)
{
...
void
NistFdBetNistFfMacScheduler::DoSchedDlPagingBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdBetNistFfMacScheduler::DoSchedDlMacBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
NistFdBetNistFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
      if (dlbandwidth < NistFdBetType0AllocationRbg[i])
        {
          return (i + 1);
        }
    }
...
int
NistFdBetNistFfMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
...
uint8_t
NistFdBetNistFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
NistFdBetNistFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
NistFdBetNistFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
NistFdBetNistFfMacScheduler::DoSchedDlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedDlTriggerReqParameters& params)
{
  ...
  std::map <uint16_t, NistfdbetsFlowPerf_t>::iterator itFlow;
          ...
          if (rbgMap.at (i) == false)
            {
              ...
              std::map <uint16_t, NistfdbetsFlowPerf_t>::iterator itPastAveThr;
  ...
  std::map <uint16_t, NistfdbetsFlowPerf_t>::iterator itStats;
...
void
NistFdBetNistFfMacScheduler::DoSchedDlRachInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdBetNistFfMacScheduler::DoSchedDlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
NistFdBetNistFfMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
NistFdBetNistFfMacScheduler::DoSchedUlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedUlTriggerReqParameters& params)
{
...
void
NistFdBetNistFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct NistFfMacSchedSapProvider::NistSchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistFdBetNistFfMacScheduler::DoSchedUlSrInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistFdBetNistFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistFdBetNistFfMacScheduler::DoSchedUlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
// retrieve the allocation for this subframe
  ...
  switch (params.m_ulCqi.m_type)
    ...
    case NistUlCqi_s::PRACH:
      {
        NS_FATAL_ERROR ("NistFdBetNistFfMacScheduler supports only PUSCH and SRS UL-CQIs");
      }
      break;
    default:
...
void
NistFdBetNistFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
NistFdBetNistFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
NistFdBetNistFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
...
void
NistFdBetNistFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
NistFdBetNistFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
