...
public:
  ...
  struct NistCschedCellConfigReqParameters
  {
    ...
    enum Nist_NormalExtended_e m_phichDuration;
    ...
    enum Nist_NormalExtended_e m_ulCyclicPrefixLength;
    enum Nist_NormalExtended_e m_dlCyclicPrefixLength;
