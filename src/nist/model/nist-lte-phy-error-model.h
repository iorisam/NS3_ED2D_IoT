...
public:
   ...
   */
  static NistTbErrorStats_t GetPsschBler (NistLteFadingModel fadingChannel, NistLteTxMode txmode, uint16_t mcs, double sinr, Nist_HarqProcessInfoList_t harqHistory);
   ...
   * \param harqHistory The HARQ information
   */
  static NistTbErrorStats_t GetPsdchBler (NistLteFadingModel fadingChannel, NistLteTxMode txmode, double sinr, Nist_HarqProcessInfoList_t harqHistory);
   ...
   * \param harqHistory The HARQ information
   */
  static NistTbErrorStats_t GetPuschBler (NistLteFadingModel fadingChannel, NistLteTxMode txmode, uint16_t mcs, double sinr, Nist_HarqProcessInfoList_t harqHistory);
