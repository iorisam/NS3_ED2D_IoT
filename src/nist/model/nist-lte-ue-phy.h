...
private:
  ...
  void DoAddDiscTxApps (std::list<std::string> apps);
  void DoAddDiscRxApps (std::list<std::string> apps);
   ...
   */
  TracedCallback<uint16_t, uint16_t, std::string> m_discoveryAnnouncementTrace;
