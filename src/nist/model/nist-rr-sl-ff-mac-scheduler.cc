...
#include <ns3/nist-rr-sl-ff-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("NistRrSlFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (NistRrSlFfMacScheduler);


class RrSlSchedulerMemberCschedSapProvider : public NistFfMacCschedSapProvider
{
public:
  RrSlSchedulerMemberCschedSapProvider (NistRrSlFfMacScheduler* scheduler);
...
private:
  RrSlSchedulerMemberCschedSapProvider ();
  NistRrSlFfMacScheduler* m_scheduler;
};

RrSlSchedulerMemberCschedSapProvider::RrSlSchedulerMemberCschedSapProvider ()
{
}

RrSlSchedulerMemberCschedSapProvider::RrSlSchedulerMemberCschedSapProvider (NistRrSlFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
RrSlSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct NistCschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
RrSlSchedulerMemberCschedSapProvider::CschedNistUeConfigReq (const struct NistCschedNistUeConfigReqParameters& params)
{
...
void
RrSlSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct NistCschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
RrSlSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct NistCschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
RrSlSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct NistCschedUeReleaseReqParameters& params)
{
  m_scheduler->DoCschedUeReleaseReq (params);
}

void
RrSlSchedulerMemberCschedSapProvider::CschedPoolConfigReq (const struct NistCschedPoolConfigReqParameters& params)
{
  m_scheduler->DoCschedPoolConfigReq (params);
}
  
void
RrSlSchedulerMemberCschedSapProvider::CschedPoolReleaseReq (const struct NistCschedPoolReleaseReqParameters& params)
{
...
class RrSlSchedulerMemberSchedSapProvider : public NistFfMacSchedSapProvider
{
public:
  RrSlSchedulerMemberSchedSapProvider (NistRrSlFfMacScheduler* scheduler);
...
private:
  RrSlSchedulerMemberSchedSapProvider ();
  NistRrSlFfMacScheduler* m_scheduler;
};



RrSlSchedulerMemberSchedSapProvider::RrSlSchedulerMemberSchedSapProvider ()
{
}


RrSlSchedulerMemberSchedSapProvider::RrSlSchedulerMemberSchedSapProvider (NistRrSlFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct NistSchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct NistSchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct NistSchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct NistSchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct NistSchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct NistSchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct NistSchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct NistSchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct NistSchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct NistSchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
RrSlSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct NistSchedUlCqiInfoReqParameters& params)
{
...
NistRrSlFfMacScheduler::NistRrSlFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiDl (0),
    m_nextLcidDl (0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new RrSlSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new RrSlSchedulerMemberSchedSapProvider (this);
}
...
void
NistRrSlFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NistRrSlFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistRrSlFfMacScheduler")
    .SetParent<NistFfMacScheduler> ()
    .AddConstructor<NistRrSlFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&NistRrSlFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&NistRrSlFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistRrSlFfMacScheduler::m_ulGrantMcs),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("Itrp",
                   "The repetition for PSSCH. Default = 0",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistRrSlFfMacScheduler::m_slItrp),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("SlGrantMcs",
                   "The MCS of the SL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistRrSlFfMacScheduler::m_slGrantMcs),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("SlGrantSize",
                   "The number of RBs allocated per UE for sidelink (default 1)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&NistRrSlFfMacScheduler::m_slGrantSize),
                   MakeUintegerChecker<uint8_t> ())
...
void
NistRrSlFfMacScheduler::SetNistFfMacCschedSapUser (NistFfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
NistRrSlFfMacScheduler::SetNistFfMacSchedSapUser (NistFfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

NistFfMacCschedSapProvider*
NistRrSlFfMacScheduler::GetNistFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

NistFfMacSchedSapProvider*
NistRrSlFfMacScheduler::GetNistFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
NistRrSlFfMacScheduler::SetNistLteFfrSapProvider (NistLteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NistLteFfrSapUser*
NistRrSlFfMacScheduler::GetNistLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
NistRrSlFfMacScheduler::DoCschedCellConfigReq (const struct NistFfMacCschedSapProvider::NistCschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrSlFfMacScheduler::DoCschedNistUeConfigReq (const struct NistFfMacCschedSapProvider::NistCschedNistUeConfigReqParameters& params)
{
...
void
NistRrSlFfMacScheduler::DoCschedLcConfigReq (const struct NistFfMacCschedSapProvider::NistCschedLcConfigReqParameters& params)
{
  //NS_LOG_FUNCTION (this);
  ...
  std::map <uint16_t, NistRrsFlowPerf_t>::iterator it;
      ...
      if (it == m_flowStatsDl.end ())
        {
          ...
          m_flowStatsDl.insert (std::pair<uint16_t, NistRrsFlowPerf_t> (params.m_rnti, flowStatsDl));
          NistRrsFlowPerf_t flowStatsUl;
          ...
          m_flowStatsUl.insert (std::pair<uint16_t, NistRrsFlowPerf_t> (params.m_rnti, flowStatsUl));
        }
      else
        {
...
void
NistRrSlFfMacScheduler::DoCschedLcReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedLcReleaseReqParameters& params)
{
...
void
NistRrSlFfMacScheduler::DoCschedUeReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedUeReleaseReqParameters& params)
{
...
void
NistRrSlFfMacScheduler::DoCschedPoolConfigReq (const struct  NistFfMacCschedSapProvider::NistCschedPoolConfigReqParameters& params)
{
...
void
NistRrSlFfMacScheduler::DoCschedPoolReleaseReq (const struct  NistFfMacCschedSapProvider::NistCschedPoolReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this << params.m_group);
  std::map <uint32_t, PoolInfo>::iterator it = m_poolAllocations.find (params.m_group);
...
void
NistRrSlFfMacScheduler::DoSchedDlRlcBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters& params)
{
...
void
NistRrSlFfMacScheduler::DoSchedDlPagingBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrSlFfMacScheduler::DoSchedDlMacBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
NistRrSlFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
bool
NistRrSlFfMacScheduler::SortRlcBufferReq (NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters i,NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters j)
{
...
uint8_t
NistRrSlFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
NistRrSlFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
NistRrSlFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
NistRrSlFfMacScheduler::DoSchedDlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedDlTriggerReqParameters& params)
{
  /************************* Comments ********************************************************************************/
  ...
  //std::cout<<" ENTER NistRrSlFfMacScheduler::DoSchedDlTriggerReq"<<std::endl;
  ...
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
    {
      ...
      if ( (((*it).m_rlcTransmissionQueueSize > 0)
        ...
        {
          NS_LOG_LOGIC (this << " User " << (*it).m_rnti << " LC " << (uint16_t)(*it).m_logicalChannelIdentity << " is active, status  " << (*it).m_rlcNistStatusPduSize << " retx " << (*it).m_rlcRetransmissionQueueSize << " tx " << (*it).m_rlcTransmissionQueueSize);
 ...
 //std::cout<<" next rnti dl = "<<(int)m_nextRntiDl<<" next lcid dl = "<<(int)m_nextLcidDl<<std::endl;
  ...
  std::list<NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itBufferAux;  //added
  ...
  do
    ...
    //case mcs = 0 : 
     ...
     int nLayer1 = NistTransmissionModesLayers::TxMode2LayerNum ((*itTxMode).second);
     std::vector< uint8_t > mcsNist;
     ...
     for (uint8_t i = 0; i < nLayer1; i++)
      {
        if (itCqi1 == m_p10CqiRxed.end ())
         {
           mcsNist.push_back (0); // no info on this user -> lowest MCS
         }
        else
         {
           mcsNist.push_back ( m_amc->GetMcsFromCqi ((*itCqi1).second) );
         }
      }
     //std::cout<<" rnti = " <<(int) (*it).m_rnti<< " mcs = " <<(int)mcsNist.at(0)<<std::endl;
     if ( mcsNist.at(0) == 0 ) 
      {
     ...
     //added 
     std::list<NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itBuffer;
      if (( m_nextRntiDl == 0) && (m_nextLcidDl==0 ) )
     ...
     do 
                      ...
                      for (uint8_t i = 0; i < nLayer; i++)
                       {
                         if (itCqi == m_p10CqiRxed.end ())
                          ...
                          {
                            mcsNist.push_back ( m_amc->GetMcsFromCqi ((*itCqi).second) );
                          }
                       }

                      b= b + iRbg;   // number of allocated RBGs + 1 (the current RBG) 
                      //std::cout<< "\t b = "<<(int)b <<std::endl;
                      bytesTxedF=(m_amc->GetTbSizeFromMcs (mcsNist.at (0), b * rbgSize) / 8) * nLayer;   //multiply by nLayer for MIMO 

                      // calculate the transmission queue size for all the flows belonging to this UE 
                      int dataToTransmit=0;
                      std::list<NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itTemp;
                         ...
                         if (((*itTemp).m_rnti== (*itBuffer).m_rnti ) && ((*itTemp).m_logicalChannelIdentity== (*itBuffer).m_logicalChannelIdentity) && ((*itBuffer).m_rnti==(*it).m_rnti) )
                          {
                            if ( ((*itBuffer).m_rlcTransmissionQueueSize > 0)
                              ...
                              || ((*itBuffer).m_rlcNistStatusPduSize > 0) )
                             {
      ...
      int tbSize = (m_amc->GetTbSizeFromMcs (newDci.m_mcs.at (0), rbgPerUE * rbgSize) / 8);
      ...
      std::list<NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itConstructDci;
      ...
      while ((*itConstructDci).m_rnti == newEl.m_rnti)
        {
          ...
          if ( ((*itConstructDci).m_rlcTransmissionQueueSize > 0)
               ...
               || ((*itConstructDci).m_rlcNistStatusPduSize > 0) )
            {
              ...
              for (uint8_t j = 0; j < nLayer; j++)
                {
                  ...
                  uint16_t rlcPduSize = (m_amc->GetTbSizeFromMcs (newDci.m_mcs.at (0), rbgRlcPdu * rbgSize) / 8);
                  ...
                  if (m_harqOn == true)
                    {
                      ...
                      std::map <uint16_t, DlHarqRlcPduListBuffer_t>::iterator itRlcPdu =  m_dlHarqProcessesRlcPduListBuffer.find ((*itConstructDci).m_rnti);
                      if (itRlcPdu == m_dlHarqProcessesRlcPduListBuffer.end ())
                        {
...
void
NistRrSlFfMacScheduler::DoSchedDlRachInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrSlFfMacScheduler::DoSchedDlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrSlFfMacScheduler::DoSchedUlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedUlTriggerReqParameters& params)
{
  /************************* Comments ********************************************************************************/
  ...
  RefreshUlCqiMaps ();
  //std::cout<<" ENTER NistRrSlFfMacScheduler::DoSchedUlTriggerReq "<<std::endl;
  // Generate RBs map
      ...
      if ( itTemp2 != satisfiedUes.end() ) 
       {
         ...
         for ( itSTemp2 = mapTemp2.begin();  itSTemp2 != mapTemp2.end(); itSTemp2 ++ ) 
          {
             UpdateUlRlcBufferInfo (uldci.m_rnti, (*itSTemp2).first, (m_amc->GetTbSizeFromMcs (uldci.m_mcs, (*itSTemp2).second) / 8)); 
          }
       }
...
void
NistRrSlFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct NistFfMacSchedSapProvider::NistSchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistRrSlFfMacScheduler::DoSchedUlSrInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistRrSlFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlMacCtrlInfoReqParameters& params)
{
  ...
  for (unsigned int i = 0; i < params.m_macCeList.size (); i++)
    {
      if ( params.m_macCeList.at (i).m_macCeType == NistMacCeListElement_s::BSR )
       ...
       else if (params.m_macCeList.at (i).m_macCeType == NistMacCeListElement_s::SLBSR )
        {
          ...
          for (uint8_t dest = 0; dest < ueIt->second.size(); ++dest)
            {
              uint8_t bsrId = params.m_macCeList.at (i).m_macCeValue.m_bufferNistStatus.at (dest);
              uint32_t buffer = NistBufferSizeLevelBsr::BsrId2BufferSize (bsrId);
              if (buffer > 0) {
...
void
NistRrSlFfMacScheduler::DoSchedUlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrSlFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
NistRrSlFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
NistRrSlFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
  std::list<NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
...
void
NistRrSlFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
...
void
NistRrSlFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
