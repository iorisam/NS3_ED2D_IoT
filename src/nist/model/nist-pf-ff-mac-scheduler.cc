...
#include <ns3/nist-pf-ff-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("NistPfFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (NistPfFfMacScheduler);



class NistPfSchedulerMemberCschedSapProvider : public NistFfMacCschedSapProvider
{
public:
  NistPfSchedulerMemberCschedSapProvider (NistPfFfMacScheduler* scheduler);
...
private:
  NistPfSchedulerMemberCschedSapProvider ();
  NistPfFfMacScheduler* m_scheduler;
};

NistPfSchedulerMemberCschedSapProvider::NistPfSchedulerMemberCschedSapProvider ()
{
}

NistPfSchedulerMemberCschedSapProvider::NistPfSchedulerMemberCschedSapProvider (NistPfFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
NistPfSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct NistCschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
NistPfSchedulerMemberCschedSapProvider::CschedNistUeConfigReq (const struct NistCschedNistUeConfigReqParameters& params)
{
...
void
NistPfSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct NistCschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
NistPfSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct NistCschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
NistPfSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct NistCschedUeReleaseReqParameters& params)
{
...
class NistPfSchedulerMemberSchedSapProvider : public NistFfMacSchedSapProvider
{
public:
  NistPfSchedulerMemberSchedSapProvider (NistPfFfMacScheduler* scheduler);
...
private:
  NistPfSchedulerMemberSchedSapProvider ();
  NistPfFfMacScheduler* m_scheduler;
};



NistPfSchedulerMemberSchedSapProvider::NistPfSchedulerMemberSchedSapProvider ()
{
}


NistPfSchedulerMemberSchedSapProvider::NistPfSchedulerMemberSchedSapProvider (NistPfFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
NistPfSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct NistSchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct NistSchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct NistSchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct NistSchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct NistSchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct NistSchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct NistSchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct NistSchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct NistSchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct NistSchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
NistPfSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct NistSchedUlCqiInfoReqParameters& params)
{
...
NistPfFfMacScheduler::NistPfFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_timeWindow (99.0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new NistPfSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new NistPfSchedulerMemberSchedSapProvider (this);
  m_ffrSapProvider = 0;
  m_ffrSapUser = new MemberNistLteFfrSapUser<NistPfFfMacScheduler> (this);
}
...
void
NistPfFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NistPfFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistPfFfMacScheduler")
    .SetParent<NistFfMacScheduler> ()
    .AddConstructor<NistPfFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&NistPfFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&NistPfFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistPfFfMacScheduler::m_ulGrantMcs),
...
void
NistPfFfMacScheduler::SetNistFfMacCschedSapUser (NistFfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
NistPfFfMacScheduler::SetNistFfMacSchedSapUser (NistFfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

NistFfMacCschedSapProvider*
NistPfFfMacScheduler::GetNistFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

NistFfMacSchedSapProvider*
NistPfFfMacScheduler::GetNistFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
NistPfFfMacScheduler::SetNistLteFfrSapProvider (NistLteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NistLteFfrSapUser*
NistPfFfMacScheduler::GetNistLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
NistPfFfMacScheduler::DoCschedCellConfigReq (const struct NistFfMacCschedSapProvider::NistCschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  ...
  cnf.m_result = SUCCESS2;
  m_cschedSapUser->CschedNistUeConfigCnf (cnf);
  return;
}

void
NistPfFfMacScheduler::DoCschedNistUeConfigReq (const struct NistFfMacCschedSapProvider::NistCschedNistUeConfigReqParameters& params)
{
...
void
NistPfFfMacScheduler::DoCschedLcConfigReq (const struct NistFfMacCschedSapProvider::NistCschedLcConfigReqParameters& params)
{
...
NS_LOG_FUNCTION (this << " New LC, rnti: "  << params.m_rnti);
  ...
  if (params.m_reconfigureFlag)
    {
      std::vector <struct NistLogicalChannelConfigListElement_s>::const_iterator lcit;

      for(lcit = params.m_logicalChannelConfigList.begin (); lcit!= params.m_logicalChannelConfigList.end (); lcit++)
        {
          NistLteFlowId_t flowid = NistLteFlowId_t (params.m_rnti,lcit->m_logicalChannelIdentity);
  ...
  else
    {
      ...
      for (lcit = params.m_logicalChannelConfigList.begin (); lcit != params.m_logicalChannelConfigList.end (); lcit++)
        {
          NistLteFlowId_t flowId = NistLteFlowId_t (params.m_rnti,lcit->m_logicalChannelIdentity);
          m_ueLogicalChannelsConfigList.insert (std::pair<NistLteFlowId_t, NistLogicalChannelConfigListElement_s>(flowId,*lcit));
        }
    }


  std::multimap <uint16_t, std::map <uint8_t, NistPfsFlowPerf_t> >::iterator it;
      ...
      if (it == m_flowStatsDl.end ())
        {
          ...
          std::map<uint8_t, NistPfsFlowPerf_t > tempMapDl;
          
          NistPfsFlowPerf_t flowStatsDl;
          ...
          tempMapDl.insert (std::pair<uint8_t, NistPfsFlowPerf_t > (params.m_logicalChannelConfigList.at (i).m_logicalChannelIdentity, flowStatsDl));
          m_flowStatsDl.insert (std::pair<uint16_t, std::map<uint8_t, NistPfsFlowPerf_t > > (params.m_rnti, tempMapDl));
        }
      else
        {
          ...
          // check if the lc already exists or not 
           ...
           std::map<uint8_t, NistPfsFlowPerf_t >::iterator itLCMap;
           ...
           if (itLCMap == it->second.end ())
            {
              ...
              flowStatsDl.secondLastAveragedThroughput = 1;
              flowStatsDl.targetThroughput = tbrDlInBytes;
              it->second.insert (std::pair<uint8_t, NistPfsFlowPerf_t > (params.m_logicalChannelConfigList.at (i).m_logicalChannelIdentity, flowStatsDl));
            }
           else
            {
      ...
      if (it == m_flowStatsUl.end ())
        {
          ...
          std::map<uint8_t, NistPfsFlowPerf_t > tempMapUl;

          NistPfsFlowPerf_t flowStatsUl;
          ...
          tempMapUl.insert (std::pair<uint8_t, NistPfsFlowPerf_t > (params.m_logicalChannelConfigList.at (i).m_logicalChannelIdentity, flowStatsUl));
          m_flowStatsUl.insert (std::pair<uint16_t, std::map<uint8_t, NistPfsFlowPerf_t > > (params.m_rnti, tempMapUl));
        }
      else
        {
          // the rnti already exists in the m_flowStatsDl
           ...
           if (itLCMap == it->second.end ())
            {
              ...
              flowStatsUl.secondLastAveragedThroughput = 1;
              flowStatsUl.targetThroughput = tbrUlInBytes;
              it->second.insert (std::pair<uint8_t, NistPfsFlowPerf_t > (params.m_logicalChannelConfigList.at (i).m_logicalChannelIdentity, flowStatsUl));
            }
           else
            {
              //update the LC Information 
...
void
NistPfFfMacScheduler::DoCschedLcReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  ...
  for (it = params.m_logicalChannelIdentity.begin (); it != params.m_logicalChannelIdentity.end (); it++)
    {
      NistLteFlowId_t flowId = NistLteFlowId_t (params.m_rnti, *it);
  ...
  for (uint16_t i = 0; i < params.m_logicalChannelIdentity.size (); i++)
    {
      std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it = m_rlcBufferReq.begin ();
      std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator temp;
...
void
NistPfFfMacScheduler::DoCschedUeReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedUeReleaseReqParameters& params)
{
 NS_LOG_FUNCTION (this);
 for (int i=0; i < MAX_LC_LIST; i++)
    {
      NistLteFlowId_t flowId = NistLteFlowId_t (params.m_rnti,i);
      // find the logical channel with the same Logical Channel Identity in the current list, release it
      if (m_ueLogicalChannelsConfigList.find (flowId)!= m_ueLogicalChannelsConfigList.end ())
        {
          m_ueLogicalChannelsConfigList.erase (flowId);
...
void
NistPfFfMacScheduler::DoSchedDlRlcBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this << params.m_rnti << (uint32_t) params.m_logicalChannelIdentity);
  // API generated by RLC for updating RLC parameters on a LC (tx and retx queues)

  std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;

  NistLteFlowId_t flow (params.m_rnti, params.m_logicalChannelIdentity);

  it =  m_rlcBufferReq.find (flow);

  if (it == m_rlcBufferReq.end ())
    {
      m_rlcBufferReq.insert (std::pair <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters> (flow, params));
    }
  else
    {
      (*it).second = params;
...
void
NistPfFfMacScheduler::DoSchedDlPagingBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistPfFfMacScheduler::DoSchedDlMacBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
NistPfFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
int
NistPfFfMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
    {
      if (((*it).first.m_rnti == rnti) && (((*it).second.m_rlcTransmissionQueueSize > 0)
                                           ...
                                           || ((*it).second.m_rlcNistStatusPduSize > 0) ))
        {
          lcActive++;
        }
...
uint8_t
NistPfFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
NistPfFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
NistPfFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
NistPfFfMacScheduler::DoSchedDlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedDlTriggerReqParameters& params)
{

  //std::cout<<" ENTER NistPfFfMacScheduler::DoSchedDlTriggerReq"<<std::endl;
  ...
  for (itRach = m_rachList.begin (); itRach != m_rachList.end (); itRach++)
    {
      ...
      NistBuildNistRarListElement_s newRar;
      ...
      ret.m_buildNistRarList.push_back (newRar);
    }
  m_rachList.clear ();
  ...
  std::vector <NistLteFlowId_t> satisfiedFlows; //structure to save satisfied flows 
  double bytesTxedF = 0;                     // accumulated data for each flows             


  std::map <NistLteFlowId_t,struct NistLogicalChannelConfigListElement_s>::iterator itLogicalChannels;
  std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itF;
  ...
  for (int i = 0; i < numberOfRBGs; i++)
    {
      ...
      if (rbgMap.at (i) == false)
        {
          std::map <NistLteFlowId_t,struct NistLogicalChannelConfigListElement_s>::iterator itLogicalChannels;
          std::map <NistLteFlowId_t,struct NistLogicalChannelConfigListElement_s>::iterator itMax = m_ueLogicalChannelsConfigList.end ();
          ...
          for (itLogicalChannels = m_ueLogicalChannelsConfigList.begin (); itLogicalChannels != m_ueLogicalChannelsConfigList.end (); itLogicalChannels++)
            {
              ...
              std::multimap <uint16_t, std::map<uint8_t, NistPfsFlowPerf_t> >:: iterator itFlowDlStats;
              std::map <uint8_t, NistPfsFlowPerf_t>:: iterator itLcDlStats;
              ...
              if ( itFlowDlStats == m_flowStatsDl.end())
               ...
               {
                  std::map <uint8_t, NistPfsFlowPerf_t> mapLcDlStats= itFlowDlStats->second;
                  std::map <uint8_t, NistPfsFlowPerf_t>:: iterator itLcDlStats= mapLcDlStats.find(itLogicalChannels->second.m_logicalChannelIdentity);
                  if (itLcDlStats == mapLcDlStats.end() ) 
                   {
                    
                    continue;
                   }   
                  std::vector <NistLteFlowId_t>::iterator Ft;
                  bool findF=false;
                  ...
                  if (findF==false)
                   {
                     std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itQ;
                     NistLteFlowId_t flowId = NistLteFlowId_t (itLogicalChannels->first.m_rnti, itLogicalChannels->second.m_logicalChannelIdentity);
                        ...
                        if (((*itQ).second.m_rlcTransmissionQueueSize > 0))
                         {
                           ...
                           std::map <uint16_t,NistSbMeasResult_s>::iterator itCqi;
                ...
                if (itMap == allocationMapPerRntiPerLCId.end ())
                  {
                    ...
                    int nLayer = NistTransmissionModesLayers::TxMode2LayerNum ((*itTxMode).second);  // nbr of layers for MIMO transmissions
                    ...
                    std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itQF;
                    NistLteFlowId_t flowIdF = NistLteFlowId_t (itMax->first.m_rnti, itMax->second.m_logicalChannelIdentity);
                    itQF = m_rlcBufferReq.find(flowIdF);
                    //std::cout<<" \t first allocation rnti = "<<(int)flowIdF.m_rnti<<" lcid = "<<(int) flowIdF.m_lcId<< " mcs = "<<(int) mcsF<<" data to transmit = " <<(int)(*itQF).second.m_rlcTransmissionQueueSize <<" allocated without n = " <<(int)(m_amc->GetTbSizeFromMcs (mcsF, b * rbgSize) / 8)<<" allocated with n = " <<(int) bytesTxedF<<std::endl;
  ...
  std::multimap <uint16_t, std::map <uint8_t, NistPfsFlowPerf_t> >::iterator itStats;
  for (itStats = m_flowStatsDl.begin (); itStats != m_flowStatsDl.end (); itStats++)
    {
       std::map <uint8_t, NistPfsFlowPerf_t>::iterator itStatsLc=itStats->second.begin();
  ...
  while (itMap != allocationMapPerRntiPerLCId.end ())
    {
      ...
      std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itBufReq; 

      // updating the rlc buffer : code modified by richard to find correctly the flow to update  
      for (itFF=MapAux.begin();itFF!=MapAux.end();itFF++) 
        {
          NistLteFlowId_t flowId ((*itMap).first, (*itFF).first);
          ...
          if (itBufReq == m_rlcBufferReq.end ())
            {
              NS_FATAL_ERROR ("Cannot find flow");
                   ...
                   || ((*itBufReq).second.m_rlcNistStatusPduSize > 0) )
            {              
              ...
              for (uint8_t j = 0; j < nLayer; j++)
                {
                  NistRlcPduListElement_s newRlcEl;     // RLC element per flow 
             ...
             // update UE stats
              std::multimap <uint16_t, std::map <uint8_t, NistPfsFlowPerf_t> >::iterator itStatsTemp1= m_flowStatsDl.find ((*itMap).first);
              if (itStatsTemp1 != m_flowStatsDl.end ())
               {
                  std::map <uint8_t, NistPfsFlowPerf_t>::iterator itStatsLcTemp1=itStatsTemp1->second.find((*itFF).first);
  ...
  for (itStats = m_flowStatsDl.begin (); itStats != m_flowStatsDl.end (); itStats++)
    {
      std::map <uint8_t, NistPfsFlowPerf_t>::iterator itStatsLcTemp2=itStats->second.begin();
...
void
NistPfFfMacScheduler::DoSchedDlRachInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistPfFfMacScheduler::DoSchedDlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
      ...
      if ( params.m_cqiList.at (i).m_cqiType == NistCqiListElement_s::P10 )
      ...
      else if ( params.m_cqiList.at (i).m_cqiType == NistCqiListElement_s::A30 )
        {
          ...
          if (it == m_a30CqiRxed.end ())
            {
              // create the new entry
              m_a30CqiRxed.insert ( std::pair<uint16_t, NistSbMeasResult_s > (rnti, params.m_cqiList.at (i).m_sbMeasResult) );
...
double
NistPfFfMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
NistPfFfMacScheduler::DoSchedUlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedUlTriggerReqParameters& params)
{
     ...
     if (rbMap.at (i) == false)
      {
        ...
        for (itLogicalChannels = m_ueLogicalChannelsConfigList.begin (); itLogicalChannels != m_ueLogicalChannelsConfigList.end (); itLogicalChannels++)
          ...
          **********************************************************************************************************************/           
           ...
           std::multimap <uint16_t, std::map <uint8_t, NistPfsFlowPerf_t> >:: iterator itFlowUlStats;
           std::map <uint8_t, NistPfsFlowPerf_t>:: iterator itLcUlStats;
           ...
           if ( itFlowUlStats == m_flowStatsUl.end())
            ...
            {
               std::map <uint8_t, NistPfsFlowPerf_t> mapLcUlStats= itFlowUlStats->second;
               std::map <uint8_t, NistPfsFlowPerf_t>:: iterator itLcUlStats= mapLcUlStats.find(itLogicalChannels->second.m_logicalChannelIdentity);
          ...
          else
           {
             ...
             if (itSMap == itMap->second.end ())
             ...
             else 
              {
                ...
                bytesTxedF=(m_amc->GetTbSizeFromMcs (mcsF, b * 1) / 8) ;   //multiply by nLayer for MIMO 
                NistLteFlowId_t flowIdF = NistLteFlowId_t (itMax->first.m_rnti, itMax->second.m_logicalChannelIdentity);
      ...
      if (itTmpBuffer!=allocationMapPerRntiPerLCId.end())
       {
         ...
         std::multimap <uint16_t, std::map <uint8_t, NistPfsFlowPerf_t> >::iterator itStatsTemp1= m_flowStatsUl.find ((*itTmpBuffer).first); 
         ...
         for (itTmpBuffer2=mapFlow1.begin(); itTmpBuffer2!=mapFlow1.end(); itTmpBuffer2++)
          {
            ...
            std::map <uint8_t, NistPfsFlowPerf_t>::iterator itStatsLcTemp1=itStatsTemp1->second.find((*itTmpBuffer2).first);                            
            if (itStatsLcTemp1 !=itStatsTemp1->second.end())
             {
               itStatsLcTemp1->second.lastTtiBytesTransmitted=(m_amc->GetTbSizeFromMcs (uldci.m_mcs, rbFlow) / 8);
             }
            else
             {
               NS_FATAL_ERROR (this << " No Stats for this allocated UE");
...
void
NistPfFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct NistFfMacSchedSapProvider::NistSchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistPfFfMacScheduler::DoSchedUlSrInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistPfFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  std::multimap <uint16_t, std::map <uint8_t, uint32_t> >::iterator it;
      ...
      if ( params.m_macCeList.at (i).m_macCeType == NistMacCeListElement_s::BSR )
        {
          ...
          std::map <uint8_t, std::vector <uint8_t> > mapBsr=params.m_macCeList.at (i).m_macCeValue.Nist_m_bufferNistStatus;
...
void
NistPfFfMacScheduler::DoSchedUlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistPfFfMacScheduler::RefreshDlCqiMaps (void)
{
  ...
  while (itA30 != m_a30CqiTimers.end ())
    {
      ...
      if ((*itA30).second == 0)
        {
          // delete correspondent entries
          std::map <uint16_t,NistSbMeasResult_s>::iterator itMap = m_a30CqiRxed.find ((*itA30).first);
...
void
NistPfFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
NistPfFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
  NistLteFlowId_t flow (rnti, lcid);
  it = m_rlcBufferReq.find (flow);
  if (it != m_rlcBufferReq.end ())
    {
      NS_LOG_INFO (this << " UE " << rnti << " LC " << (uint16_t)lcid << " txqueue " << (*it).second.m_rlcTransmissionQueueSize << " retxqueue " << (*it).second.m_rlcRetransmissionQueueSize << " status " << (*it).second.m_rlcNistStatusPduSize << " decrease " << size);
      // Update queues: RLC tx order NistStatus, ReTx, Tx
      // Update status queue
      if (((*it).second.m_rlcNistStatusPduSize > 0) && (size >= (*it).second.m_rlcNistStatusPduSize))
        {
          (*it).second.m_rlcNistStatusPduSize = 0;
        }
...
void
NistPfFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{

 //std::cout<<"At time: "<< Simulator::Now().GetSeconds ()<<" ENTER NistPfFfMacScheduler::UpdateUlRlcBufferInfo " <<std::endl;
...
void
NistPfFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
