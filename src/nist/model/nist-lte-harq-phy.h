...
typedef std::vector <NistHarqProcessInfoElement_t> Nist_HarqProcessInfoList_t;
...
public:
  ...
  */
  Nist_HarqProcessInfoList_t GetHarqProcessInfoDl (uint8_t harqProcId, uint8_t layer);
  ...
  * \return the vector of the info related to HARQ proc Id
  */
  Nist_HarqProcessInfoList_t GetHarqProcessInfoUl (uint16_t rnti, uint8_t harqProcId);
  ...
  * \return the vector of the info related to HARQ proc Id
  */
  Nist_HarqProcessInfoList_t GetHarqProcessInfoSl (uint16_t rnti, uint8_t l1dst);
  ...
  * \return the vector of the info related to HARQ proc Id
  */
  Nist_HarqProcessInfoList_t GetHarqProcessInfoDisc (uint16_t rnti, uint8_t resPsdch);
...
private:
  ...
  std::vector <std::vector <Nist_HarqProcessInfoList_t> > m_miDlHarqProcessesInfoMap;
  std::map <uint16_t, std::vector <Nist_HarqProcessInfoList_t> > m_miUlHarqProcessesInfoMap;
  std::map <uint16_t, std::map <uint8_t , Nist_HarqProcessInfoList_t> > m_miSlHarqProcessesInfoMap;
  std::map <uint16_t, std::map <uint8_t , Nist_HarqProcessInfoList_t> > m_miDiscHarqProcessesInfoMap;
