...
#ifndef NIST_LTE_MI_ERROR_MODEL_H
#define NIST_LTE_MI_ERROR_MODEL_H
...
public:
   ...
   */
  static NistTbStats_t GetTbDecodificationStats (const SpectrumValue& sinr, const std::vector<int>& map, uint16_t size, uint8_t mcs, Nist_HarqProcessInfoList_t miHistory);
...
#endif /* NIST_LTE_MI_ERROR_MODEL_H */
