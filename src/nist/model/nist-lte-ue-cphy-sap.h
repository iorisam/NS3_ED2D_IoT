...
public:
   ...
   */
   virtual void AddDiscTxApps (std::list<std::string> apps) = 0;

  /**
   * set discovery monitoring apps
   * \param apps applications we are interested in monitoring
   */
   virtual void AddDiscRxApps (std::list<std::string> apps) = 0;
...
public:
  ...
  virtual void AddDiscTxApps (std::list<std::string> apps);
  virtual void AddDiscRxApps (std::list<std::string> apps);
  //communication
...
template <class C>
void NistMemberLteUeCphySapProvider<C>::AddDiscTxApps (std::list<std::string> apps)
{
  m_owner->DoAddDiscTxApps (apps);
}

template <class C>
void NistMemberLteUeCphySapProvider<C>::AddDiscRxApps (std::list<std::string> apps)
{
