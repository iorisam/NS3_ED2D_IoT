...
#include <ns3/nist-priority-ff-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("NistPriorityFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (NistPriorityFfMacScheduler);



class PrioritySchedulerMemberCschedSapProvider : public NistFfMacCschedSapProvider
{
public:
  PrioritySchedulerMemberCschedSapProvider (NistPriorityFfMacScheduler* scheduler);
...
private:
  PrioritySchedulerMemberCschedSapProvider ();
  NistPriorityFfMacScheduler* m_scheduler;
};

PrioritySchedulerMemberCschedSapProvider::PrioritySchedulerMemberCschedSapProvider ()
{
}

PrioritySchedulerMemberCschedSapProvider::PrioritySchedulerMemberCschedSapProvider (NistPriorityFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
PrioritySchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct NistCschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
PrioritySchedulerMemberCschedSapProvider::CschedNistUeConfigReq (const struct NistCschedNistUeConfigReqParameters& params)
{
...
void
PrioritySchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct NistCschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
PrioritySchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct NistCschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
PrioritySchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct NistCschedUeReleaseReqParameters& params)
{
...
class PrioritySchedulerMemberSchedSapProvider : public NistFfMacSchedSapProvider
{
public:
  PrioritySchedulerMemberSchedSapProvider (NistPriorityFfMacScheduler* scheduler);
...
private:
  PrioritySchedulerMemberSchedSapProvider ();
  NistPriorityFfMacScheduler* m_scheduler;
};



PrioritySchedulerMemberSchedSapProvider::PrioritySchedulerMemberSchedSapProvider ()
{
}


PrioritySchedulerMemberSchedSapProvider::PrioritySchedulerMemberSchedSapProvider (NistPriorityFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
PrioritySchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct NistSchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct NistSchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct NistSchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct NistSchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct NistSchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct NistSchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct NistSchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct NistSchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct NistSchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct NistSchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
PrioritySchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct NistSchedUlCqiInfoReqParameters& params)
{
...
NistPriorityFfMacScheduler::NistPriorityFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_timeWindow (99.0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new PrioritySchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new PrioritySchedulerMemberSchedSapProvider (this);
  m_ffrSapProvider = 0;
  m_ffrSapUser = new MemberNistLteFfrSapUser<NistPriorityFfMacScheduler> (this);
}
...
void
NistPriorityFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NistPriorityFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistPriorityFfMacScheduler")
    .SetParent<NistFfMacScheduler> ()
    .AddConstructor<NistPriorityFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&NistPriorityFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&NistPriorityFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistPriorityFfMacScheduler::m_ulGrantMcs),
...
void
NistPriorityFfMacScheduler::SetNistFfMacCschedSapUser (NistFfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
NistPriorityFfMacScheduler::SetNistFfMacSchedSapUser (NistFfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

NistFfMacCschedSapProvider*
NistPriorityFfMacScheduler::GetNistFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

NistFfMacSchedSapProvider*
NistPriorityFfMacScheduler::GetNistFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
NistPriorityFfMacScheduler::SetNistLteFfrSapProvider (NistLteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NistLteFfrSapUser*
NistPriorityFfMacScheduler::GetNistLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
NistPriorityFfMacScheduler::DoCschedCellConfigReq (const struct NistFfMacCschedSapProvider::NistCschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistPriorityFfMacScheduler::DoCschedNistUeConfigReq (const struct NistFfMacCschedSapProvider::NistCschedNistUeConfigReqParameters& params)
{
...
void
NistPriorityFfMacScheduler::DoCschedLcConfigReq (const struct NistFfMacCschedSapProvider::NistCschedLcConfigReqParameters& params)
{
...
NS_LOG_FUNCTION (this << " New LC, rnti: "  << params.m_rnti);
  ...
  std::map <uint16_t, NistPrioritysFlowPerf_t>::iterator it;
      ...
      if (it == m_flowStatsDl.end ())
        {
          ...
          NistPrioritysFlowPerf_t flowStatsDl;
          ...
          m_flowStatsDl.insert (std::pair<uint16_t, NistPrioritysFlowPerf_t> (params.m_rnti, flowStatsDl));
          NistPrioritysFlowPerf_t flowStatsUl;
          ...
          m_flowStatsUl.insert (std::pair<uint16_t, NistPrioritysFlowPerf_t> (params.m_rnti, flowStatsUl));
        }
      else
        {
...
void
NistPriorityFfMacScheduler::DoCschedLcReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistPriorityFfMacScheduler::DoCschedUeReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedUeReleaseReqParameters& params)
{
 NS_LOG_FUNCTION (this);
...
void
NistPriorityFfMacScheduler::DoSchedDlRlcBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters& params)
{
...
void
NistPriorityFfMacScheduler::DoSchedDlPagingBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistPriorityFfMacScheduler::DoSchedDlMacBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
NistPriorityFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
int
NistPriorityFfMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
...
uint8_t
NistPriorityFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
NistPriorityFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
NistPriorityFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
NistPriorityFfMacScheduler::DoSchedDlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedDlTriggerReqParameters& params)
{
 ...
 RefreshDlCqiMaps ();
  ...
  std::vector <NistLteFlowId_t> satisfiedFlows;  //structure to save the satisfied flows: flows that have obtained the required RBGs to transmit their pending data  
...
void
NistPriorityFfMacScheduler::DoSchedDlRachInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistPriorityFfMacScheduler::DoSchedDlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
NistPriorityFfMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
NistPriorityFfMacScheduler::DoSchedUlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedUlTriggerReqParameters& params)
{
/*********************************** Priority based UL scheduler **************************************************/
     ...
     if (rbMap.at (i) == false)
      {
        ...
        for (itLogicalChannels = m_ueLogicalChannelsConfigList.begin (); itLogicalChannels != m_ueLogicalChannelsConfigList.end (); itLogicalChannels++)
          ...
          **********************************************************************************************************************/           
           ...
           NistLteFlowId_t flowId1 ;      //trying to find this flow in the satisfied flows 
           flowId1.m_rnti= itLogicalChannels->first.m_rnti;
           flowId1.m_lcId= itLogicalChannels->second.m_logicalChannelIdentity;
           std::vector <NistLteFlowId_t>::iterator Ft;
           bool findF=false;
  ...
  if (nflows == 0)
   ...
   std::map <uint16_t, NistPrioritysFlowPerf_t>::iterator itStats;
   if (m_nextRntiUl != 0)
    {
      for (it = m_ceBsrRxed.begin (); it !=m_ceBsrRxed.end (); it++)
        {
...
void
NistPriorityFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct NistFfMacSchedSapProvider::NistSchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistPriorityFfMacScheduler::DoSchedUlSrInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistPriorityFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  std::multimap <uint16_t, std::map <uint8_t, uint32_t> >::iterator it;
...
void
NistPriorityFfMacScheduler::DoSchedUlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  ...
  switch (params.m_ulCqi.m_type)
    ...
    case NistUlCqi_s::PRACH:
      {
        NS_FATAL_ERROR ("PriorityFfMacScheduler supports only PUSCH and SRS UL-CQIs");
      }
      break;
    default:
...
void
NistPriorityFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
NistPriorityFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
NistPriorityFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
...
void
NistPriorityFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{

 //std::cout<<"At time: "<< Simulator::Now().GetSeconds ()<<" ENTER NistPriorityFfMacScheduler::UpdateUlRlcBufferInfo " <<std::endl;
...
void
NistPriorityFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
