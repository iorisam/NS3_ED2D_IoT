...
#include <ns3/nist-rr-ff-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("NistRrFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (NistRrFfMacScheduler);


class NistRrSchedulerMemberCschedSapProvider : public NistFfMacCschedSapProvider
{
public:
  NistRrSchedulerMemberCschedSapProvider (NistRrFfMacScheduler* scheduler);
...
private:
  NistRrSchedulerMemberCschedSapProvider ();
  NistRrFfMacScheduler* m_scheduler;
};

NistRrSchedulerMemberCschedSapProvider::NistRrSchedulerMemberCschedSapProvider ()
{
}

NistRrSchedulerMemberCschedSapProvider::NistRrSchedulerMemberCschedSapProvider (NistRrFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
NistRrSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct NistCschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
NistRrSchedulerMemberCschedSapProvider::CschedNistUeConfigReq (const struct NistCschedNistUeConfigReqParameters& params)
{
...
void
NistRrSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct NistCschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
NistRrSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct NistCschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
NistRrSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct NistCschedUeReleaseReqParameters& params)
{
...
class NistRrSchedulerMemberSchedSapProvider : public NistFfMacSchedSapProvider
{
public:
  NistRrSchedulerMemberSchedSapProvider (NistRrFfMacScheduler* scheduler);
...
private:
  NistRrSchedulerMemberSchedSapProvider ();
  NistRrFfMacScheduler* m_scheduler;
};



NistRrSchedulerMemberSchedSapProvider::NistRrSchedulerMemberSchedSapProvider ()
{
}


NistRrSchedulerMemberSchedSapProvider::NistRrSchedulerMemberSchedSapProvider (NistRrFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
NistRrSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct NistSchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct NistSchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct NistSchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct NistSchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct NistSchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct NistSchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct NistSchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct NistSchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct NistSchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct NistSchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
NistRrSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct NistSchedUlCqiInfoReqParameters& params)
{
...
NistRrFfMacScheduler::NistRrFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiDl (0),
    m_nextLcidDl (0),
    ...
    m_nextLcidUl (0)
{
  ...
  m_cschedSapProvider = new NistRrSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new NistRrSchedulerMemberSchedSapProvider (this);
}
...
void
NistRrFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NistRrFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistRrFfMacScheduler")
    .SetParent<NistFfMacScheduler> ()
    .AddConstructor<NistRrFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&NistRrFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&NistRrFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistRrFfMacScheduler::m_ulGrantMcs),
...
void
NistRrFfMacScheduler::SetNistFfMacCschedSapUser (NistFfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
NistRrFfMacScheduler::SetNistFfMacSchedSapUser (NistFfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

NistFfMacCschedSapProvider*
NistRrFfMacScheduler::GetNistFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

NistFfMacSchedSapProvider*
NistRrFfMacScheduler::GetNistFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
NistRrFfMacScheduler::SetNistLteFfrSapProvider (NistLteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NistLteFfrSapUser*
NistRrFfMacScheduler::GetNistLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
NistRrFfMacScheduler::DoCschedCellConfigReq (const struct NistFfMacCschedSapProvider::NistCschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrFfMacScheduler::DoCschedNistUeConfigReq (const struct NistFfMacCschedSapProvider::NistCschedNistUeConfigReqParameters& params)
{
...
void
NistRrFfMacScheduler::DoCschedLcConfigReq (const struct NistFfMacCschedSapProvider::NistCschedLcConfigReqParameters& params)
{
...
void
NistRrFfMacScheduler::DoCschedLcReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrFfMacScheduler::DoCschedUeReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrFfMacScheduler::DoSchedDlRlcBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters& params)
{
...
void
NistRrFfMacScheduler::DoSchedDlPagingBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrFfMacScheduler::DoSchedDlMacBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
NistRrFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
   {
...
bool
NistRrFfMacScheduler::SortRlcBufferReq (NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters i,NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters j)
{
...
int
NistRrFfMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
...
uint8_t
NistRrFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
NistRrFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
NistRrFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
NistRrFfMacScheduler::DoSchedDlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedDlTriggerReqParameters& params)
{
  ...
  for (itRach = m_rachList.begin (); itRach != m_rachList.end (); itRach++)
    {
      ...
      NS_LOG_INFO (this << " UL grant allocated to RNTI " << (*itRach).m_rnti << " rbStart " << rbStart << " rbLen " << rbLen << " MCS " << (uint16_t) m_ulGrantMcs << " tbSize " << newNistRar.m_grant.m_tbSize);
  ...
  std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itDL= m_rlcBufferReq.begin();
  ...
  std::map <NistLteFlowId_t,struct NistLogicalChannelConfigListElement_s>::iterator itTemp1;
  ...
  std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itBuffer;
  ...
  for (int i = 0; i < numberOfRBGs; i++)
   {
      ...
      //std::cout<<"\t ALLOCATION for RBG " << i << " of " << numberOfRBGs<<std::endl;
    
      if (rbgMap.at (i) == false)    // this RBG is not allocated
        {
          std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itLogicalChannels;
          std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itMax = m_rlcBufferReq.end ();
          
          NistLteFlowId_t m_next_flow = NistLteFlowId_t (m_nextRntiDl, m_nextLcidDl);
              ...
              if ((itRnti != rntiAllocated.end ())||(!HarqProcessAvailability (itLogicalChannels->first.m_rnti)))
               {
                 ...
                 m_next_flow = NistLteFlowId_t (m_nextRntiDl, m_nextLcidDl);
                 continue;
               }
                 ...
                 if (itQ!=m_rlcBufferReq.end())
                  {
                    if (((*itQ).second.m_rlcTransmissionQueueSize > 0))
                     ...
                     else 
                      {
                         ...
                         m_nextRntiDl = itLogicalChannels->first.m_rnti;
                         m_nextLcidDl = itLogicalChannels->first.m_lcId;  
                         m_next_flow = NistLteFlowId_t (m_nextRntiDl, m_nextLcidDl);   // added ! 
                         continue;
                      }
                ...
                if (itMap == allocationMapPerRntiPerLCId.end ())
                  {
                    ...
                    NistLteFlowId_t flowIdF = NistLteFlowId_t (itMax->first.m_rnti, itMax->first.m_lcId);
                    ...
                    if ((*itQF).second.m_rlcTransmissionQueueSize <= bytesTxedF )
                     {
                        ...
                        std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itLogicalChannels2;
                        NistLteFlowId_t flow2 = NistLteFlowId_t (itMax->first.m_rnti, itMax->first.m_lcId);
                    ...
                    /***********************************************************************************/
                     ...
                     else 
                     {
                       ...
                       if (itCqi == m_p10CqiRxed.end ())
                        ...
                        NistLteFlowId_t flowIdF = NistLteFlowId_t (itMax->first.m_rnti, itMax->first.m_lcId);
                        itQF = m_rlcBufferReq.find(flowIdF);
                        //std::cout<<" \t additional allocation rnti = "<<(int)flowIdF.m_rnti<<" lcid = "<<(int) flowIdF.m_lcId<< " data to transmit = " <<(int)(*itQF).second.m_rlcTransmissionQueueSize <<" allocated without n = " <<(int)(m_amc->GetTbSizeFromMcs (mcsF, b * rbgSize) / 8)<<" allocated with n = " <<(int) bytesTxedF<<std::endl;
...
void
NistRrFfMacScheduler::DoSchedDlRachInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistRrFfMacScheduler::DoSchedDlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
NistRrFfMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
NistRrFfMacScheduler::DoSchedUlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedUlTriggerReqParameters& params)
{
  //std::cout<<" ENTER NistRrFfMacScheduler::DoSchedUlTriggerReq"<<std::endl;
 ...
 if (rbAllocatedNum == rbNum)
  ...
  std::map< NistLteFlowId_t, uint32_t> InitialAllocatedRbs;
   ...
   for ( it1= allocationMapPerRntiPerLCId.begin(); it1 != allocationMapPerRntiPerLCId.end(); it1 ++)
    {
         ...
         for ( it2= maptemp.begin(); it2 != maptemp.end(); it2 ++)
          {
             NistLteFlowId_t flow = NistLteFlowId_t (it1->first, it2->first);
             InitialAllocatedRbs.insert ( std::pair <NistLteFlowId_t, uint32_t>  (flow, it2->second.size() ));
          }
    }
     ...
     if (rbMap.at (i) == false)
      {
        ...
        NistLteFlowId_t m_next_Ul_flow = NistLteFlowId_t (m_nextRntiUl, m_nextLcidUl);
                 ...
                 if (itLC!=mapLC.end())      
                  {
                    if ((*itLC).second > 0)
                    ...
                    else
                     {
                        ...
                        m_next_Ul_flow = NistLteFlowId_t (m_nextRntiUl, m_nextLcidUl);   // added ! 
          ...
          if (itMap == allocationMapPerRntiPerLCId.end ())
           {
             ...
             /************ trying to see if this flow is satisfied by this first allocation   ***************************/ 
                ...
                bytesTxedF=(m_amc->GetTbSizeFromMcs (mcsF, 1) / 8) ; 
          ...
          else
           {
             ...
             if (itSMap == itMap->second.end ())
             ...
             else 
              {
                ...
                NistLteFlowId_t flowInitial = NistLteFlowId_t (itMax->first.m_rnti, itMax->second.m_logicalChannelIdentity);
                std::map< NistLteFlowId_t, uint32_t>::iterator itInittial= InitialAllocatedRbs.find( flowInitial );
        ...
        for (itTmp2=mapFlow1.begin(); itTmp2!=mapFlow1.end(); itTmp2++)
         {
           ...
           NistLteFlowId_t flowInitial = NistLteFlowId_t ((*it).first, (*itTmp2).first);
           std::map< NistLteFlowId_t, uint32_t>::iterator itInittial= InitialAllocatedRbs.find( flowInitial );
           uint32_t initialRbAllocated= itInittial->second;
...
void
NistRrFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct NistFfMacSchedSapProvider::NistSchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistRrFfMacScheduler::DoSchedUlSrInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistRrFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlMacCtrlInfoReqParameters& params)
{

   //std::cout<<" ENTER NistRrFfMacScheduler::DoSchedUlMacCtrlInfoReq "<<std::endl;
  NS_LOG_FUNCTION (this);
  std::multimap <uint16_t, std::map <uint8_t, uint32_t> >::iterator it;
...
void
NistRrFfMacScheduler::DoSchedUlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params)
{
...
void
NistRrFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
NistRrFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
NistRrFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  //std::cout<<" ENTER NistRrFfMacScheduler::UpdateDlRlcBufferInfo "<<std::endl;
  ...
  if (it != m_rlcBufferReq.end ())
    {
      ...
      //std::cout << " UE " << rnti << " LC " << (int)lcid << " txqueue " << (int) (*it).second.m_rlcTransmissionQueueSize << " retxqueue " << (int)(*it).second.m_rlcRetransmissionQueueSize << " status " << (int)(*it).second.m_rlcNistStatusPduSize << " decrease " << (int) size << std::endl;
...
void
NistRrFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
...
void
NistRrFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
