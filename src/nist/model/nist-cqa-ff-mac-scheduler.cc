...
#include <ns3/nist-cqa-ff-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("NistCqaFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (NistCqaFfMacScheduler);
...
typedef std::map<CQI_value,NistLteFlowId_t,bool(*)(uint8_t,uint8_t)> t_map_CQIToUE; //sorted
...
typedef std::map<CQI_value,NistLteFlowId_t,bool(*)(uint8_t,uint8_t)>::iterator t_it_CQIToUE; //sorted
...
typedef std::multimap<HOL_group,std::set<NistLteFlowId_t>,bool(*)(int,int)> t_map_HOLgroupToUEs;
typedef std::map<HOL_group,std::set<NistLteFlowId_t> >::iterator t_it_HOLgroupToUEs;

//typedef std::map<RBG_index,CQI_value>  map_RBG_to_CQI;
//typedef std::map<NistLteFlowId_t,map_RBG_to_CQI> map_flowId_to_CQI_map;
...
class NistCqaSchedulerMemberCschedSapProvider : public NistFfMacCschedSapProvider
{
public:
  NistCqaSchedulerMemberCschedSapProvider (NistCqaFfMacScheduler* scheduler);
...
private:
  NistCqaSchedulerMemberCschedSapProvider ();
  NistCqaFfMacScheduler* m_scheduler;
};

NistCqaSchedulerMemberCschedSapProvider::NistCqaSchedulerMemberCschedSapProvider ()
{
}

NistCqaSchedulerMemberCschedSapProvider::NistCqaSchedulerMemberCschedSapProvider (NistCqaFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
NistCqaSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct NistCschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
NistCqaSchedulerMemberCschedSapProvider::CschedNistUeConfigReq (const struct NistCschedNistUeConfigReqParameters& params)
{
...
void
NistCqaSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct NistCschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
NistCqaSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct NistCschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
NistCqaSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct NistCschedUeReleaseReqParameters& params)
{
...
class NistCqaSchedulerMemberSchedSapProvider : public NistFfMacSchedSapProvider
{
public:
  NistCqaSchedulerMemberSchedSapProvider (NistCqaFfMacScheduler* scheduler);
...
private:
  NistCqaSchedulerMemberSchedSapProvider ();
  NistCqaFfMacScheduler* m_scheduler;
};



NistCqaSchedulerMemberSchedSapProvider::NistCqaSchedulerMemberSchedSapProvider ()
{
}


NistCqaSchedulerMemberSchedSapProvider::NistCqaSchedulerMemberSchedSapProvider (NistCqaFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct NistSchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct NistSchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct NistSchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct NistSchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct NistSchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct NistSchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct NistSchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct NistSchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct NistSchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct NistSchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
NistCqaSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct NistSchedUlCqiInfoReqParameters& params)
{
...
NistCqaFfMacScheduler::NistCqaFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_timeWindow (99.0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new NistCqaSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new NistCqaSchedulerMemberSchedSapProvider (this);
  m_ffrSapProvider = 0;
  m_ffrSapUser = new MemberNistLteFfrSapUser<NistCqaFfMacScheduler> (this);
}
...
void
NistCqaFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NistCqaFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistCqaFfMacScheduler")
    .SetParent<NistFfMacScheduler> ()
    .AddConstructor<NistCqaFfMacScheduler>()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&NistCqaFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("CqaMetric",
                   "NistCqaFfMacScheduler metric type that can be: CqaFf, CqaPf",
                   StringValue ("CqaFf"),
                   MakeStringAccessor (&NistCqaFfMacScheduler::m_CqaMetric),
                   MakeStringChecker ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&NistCqaFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&NistCqaFfMacScheduler::m_ulGrantMcs),
...
void
NistCqaFfMacScheduler::SetNistFfMacCschedSapUser (NistFfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
NistCqaFfMacScheduler::SetNistFfMacSchedSapUser (NistFfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

NistFfMacCschedSapProvider*
NistCqaFfMacScheduler::GetNistFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

NistFfMacSchedSapProvider*
NistCqaFfMacScheduler::GetNistFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
NistCqaFfMacScheduler::SetNistLteFfrSapProvider (NistLteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NistLteFfrSapUser*
NistCqaFfMacScheduler::GetNistLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
NistCqaFfMacScheduler::DoCschedCellConfigReq (const struct NistFfMacCschedSapProvider::NistCschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistCqaFfMacScheduler::DoCschedNistUeConfigReq (const struct NistFfMacCschedSapProvider::NistCschedNistUeConfigReqParameters& params)
{
...
void
NistCqaFfMacScheduler::DoCschedLcConfigReq (const struct NistFfMacCschedSapProvider::NistCschedLcConfigReqParameters& params)
{
  ...
  std::map <uint16_t, NistCqasFlowPerf_t>::iterator it;
      ...
      if (it == m_flowStatsDl.end ())
        {
          ...
          NistCqasFlowPerf_t flowStatsDl;
          ...
          m_flowStatsDl.insert (std::pair<uint16_t, NistCqasFlowPerf_t> (params.m_rnti, flowStatsDl));
          NistCqasFlowPerf_t flowStatsUl;
          ...
          m_flowStatsUl.insert (std::pair<uint16_t, NistCqasFlowPerf_t> (params.m_rnti, flowStatsUl));
        }
      else
        {
          // update GBR from NistUeManager::SetupDataRadioBearer ()
          double tbrDlInBytes = params.m_logicalChannelConfigList.at (i).m_eRabGuaranteedBitrateDl / 8;   // byte/s
          double tbrUlInBytes = params.m_logicalChannelConfigList.at (i).m_eRabGuaranteedBitrateUl / 8;   // byte/s
...
void
NistCqaFfMacScheduler::DoCschedLcReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistCqaFfMacScheduler::DoCschedUeReleaseReq (const struct NistFfMacCschedSapProvider::NistCschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistCqaFfMacScheduler::DoSchedDlRlcBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters& params)
{
...
void
NistCqaFfMacScheduler::DoSchedDlPagingBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistCqaFfMacScheduler::DoSchedDlMacBufferReq (const struct NistFfMacSchedSapProvider::NistSchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
NistCqaFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
int
NistCqaFfMacScheduler::LcActivePerFlow (uint16_t rnti)
{
  std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
...
uint8_t
NistCqaFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
NistCqaFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
NistCqaFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
NistCqaFfMacScheduler::DoSchedDlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedDlTriggerReqParameters& params)
{
  ...
  std::map<NistLteFlowId_t,int> UEtoHOL;
  ...
  for (itRach = m_rachList.begin (); itRach != m_rachList.end (); itRach++)
    {
      ...
      NS_LOG_INFO (this << " UL grant allocated to RNTI " << (*itRach).m_rnti << " rbStart " << rbStart << " rbLen " << rbLen << " MCS " << m_ulGrantMcs << " tbSize " << newNistRar.m_grant.m_tbSize);
  ...
  for (itLogicalChannels = m_ueLogicalChannelsConfigList.begin (); itLogicalChannels != m_ueLogicalChannelsConfigList.end (); itLogicalChannels++)
    {
      ...
      std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itRlcBufferReq = m_rlcBufferReq.find (itLogicalChannels->first);
      ...
      UEtoHOL.insert (std::pair<NistLteFlowId_t,int>(itLogicalChannels->first,delay));

      if (itLogicalChannels->second.m_qosBearerType == itLogicalChannels->second.QBT_NON_GBR )
        {
          if (map_nonGBRHOLgroupToUE.count (group)==0)
            {
              std::set<NistLteFlowId_t> v;
              v.insert (itRlcBufferReq->first);
              map_nonGBRHOLgroupToUE.insert (std::pair<int,std::set<NistLteFlowId_t> >(group,v));
            }
          else
            {
          ...
          if (map_GBRHOLgroupToUE.count (group)==0)
            {
              std::set<NistLteFlowId_t> v;
              v.insert (itRlcBufferReq->first);
              map_GBRHOLgroupToUE.insert (std::pair<int,std::set<NistLteFlowId_t> >(group,v));
            }
          else
            {
  ...
  std::map<NistLteFlowId_t, int> UeToAmountOfDataToTransfer;
  //Initialize the map per UE, how much resources is already assigned to the user
  std::map<NistLteFlowId_t, int> UeToAmountOfAssignedResources;
  ...
  for( std::map <NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator itrbr = m_rlcBufferReq.begin ();
       itrbr!=m_rlcBufferReq.end (); itrbr++)
    {

      NistLteFlowId_t flowId = itrbr->first;                // Prepare data for the scheduling mechanism
      // map: UE, to the amount of traffic they have to transfer
      ...
      UeToAmountOfDataToTransfer.insert (std::pair<NistLteFlowId_t,int>(flowId,amountOfDataToTransfer));
      UeToAmountOfAssignedResources.insert (std::pair<NistLteFlowId_t,int>(flowId,0));
      ...
      while (availableRBGs.size ()>0 and itCurrentGroup->second.size ()>0)
        {
          ...
          std::map<NistLteFlowId_t, CQI_value> UeToCQIValue;
          std::map<NistLteFlowId_t, double > UeToCoitaMetric;
          std::map<NistLteFlowId_t, bool> UeHasReachedGBR;
          double maximumValueMetric = 0;
          NistLteFlowId_t userWithMaximumMetric;
          UeToCQIValue.clear ();
          ...
          for (std::set<NistLteFlowId_t>::iterator it=itCurrentGroup->second.begin (); it!=itCurrentGroup->second.end (); it++)
            {
              NistLteFlowId_t flowId = *it;
              ...
              NistLogicalChannelConfigListElement_s lc = m_ueLogicalChannelsConfigList.find (flowId)->second;
              std::map <uint16_t,NistSbMeasResult_s>::iterator itRntiCQIsMap = m_a30CqiRxed.find (flowId.m_rnti);

              std::map <uint16_t, NistCqasFlowPerf_t>::iterator itStats;
              ...
              if (itRntiCQIsMap != m_a30CqiRxed.end ())
                {
                  ...
                  UeToCQIValue.insert (std::pair<NistLteFlowId_t,CQI_value>(flowId,cqi_value));
                  UeToCoitaMetric.insert (std::pair<NistLteFlowId_t, double>(flowId,coita_metric));
                }
              ...
              NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters lcBufferInfo = m_rlcBufferReq.find (flowId)->second;

              if (UeToAmountOfDataToTransfer.find (flowId)->second - UeToAmountOfAssignedResources.find (flowId)->second < 0)
                {
                  UeHasReachedGBR.insert (std::pair<NistLteFlowId_t,bool>(flowId,false));
                }
              ...
              if(bitRateWithNewRBG > lc.m_eRabGuaranteedBitrateDl)
                {
                  UeHasReachedGBR.insert (std::pair<NistLteFlowId_t,bool>(flowId,true));
                }
              else
                {
                  UeHasReachedGBR.insert (std::pair<NistLteFlowId_t,bool>(flowId,false));
  ...
  while (itMap != allocationMapPerRntiPerLCId.end ())
    {
      // create new NistBuildDataListElement_s for this LC
      NistBuildDataListElement_s newEl;
      ...
      // NOTE: In this first version of NistCqaFfMacScheduler, it is assumed one flow per user.
...
void
NistCqaFfMacScheduler::DoSchedDlRachInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistCqaFfMacScheduler::DoSchedDlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
NistCqaFfMacScheduler::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
NistCqaFfMacScheduler::DoSchedUlTriggerReq (const struct NistFfMacSchedSapProvider::NistSchedUlTriggerReqParameters& params)
{
...
void
NistCqaFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct NistFfMacSchedSapProvider::NistSchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistCqaFfMacScheduler::DoSchedUlSrInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
NistCqaFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistCqaFfMacScheduler::DoSchedUlCqiInfoReq (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
// retrieve the allocation for this subframe
  ...
  switch (params.m_ulCqi.m_type)
    ...
    case NistUlCqi_s::PRACH:
      {
        NS_FATAL_ERROR ("NistPfFfMacScheduler supports only PUSCH and SRS UL-CQIs");
      }
      break;
    default:
...
void
NistCqaFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
NistCqaFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
NistCqaFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<NistLteFlowId_t, NistFfMacSchedSapProvider::NistSchedDlRlcBufferReqParameters>::iterator it;
...
void
NistCqaFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
NistCqaFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
