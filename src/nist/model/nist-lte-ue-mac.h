...
public:
  ...
  */
  ...
  typedef void (* DiscoveryAnnouncementTracedCallback) 
    (const uint16_t rnti, const std::string proSeAppCode);
...
private:
   ...
   */
  TracedCallback<uint16_t, std::string> m_discoveryAnnouncementTrace;
  ...
  void DoModifyDiscTxApps (std::list<std::string> apps);
  void DoModifyDiscRxApps (std::list<std::string> apps);
