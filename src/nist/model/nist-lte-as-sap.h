...
public:
   ...
   */
  virtual void AddDiscoveryApps (std::list<std::string> apps, bool rxtx) = 0;
   ...
   * \param rxtx 0 for monitoring and 1 for announcing
   */
  virtual void RemoveDiscoveryApps (std::list<std::string> apps, bool rxtx) = 0;
...
public:
  ...
  //Discovery
  virtual void AddDiscoveryApps (std::list<std::string> apps, bool rxtx);
  virtual void RemoveDiscoveryApps (std::list<std::string> apps, bool rxtx);
...
template <class C>
void
NistMemberLteAsSapProvider<C>::AddDiscoveryApps (std::list<std::string> apps, bool rxtx)
{
...
template <class C>
void
NistMemberLteAsSapProvider<C>::RemoveDiscoveryApps (std::list<std::string> apps, bool rxtx)
{
