...
int main (int argc, char** argv)
{
 ...
 LrWpanEnergySourceHelper lrSourceHelper;
  ...
  lrSourceHelper.Set("LrWpanEnergySourceInitialEnergyJ",DoubleValue(10) );
  // install source
  EnergySourceContainer sources = lrSourceHelper.Install (nodes);
  /* device energy model */
  ...
  DeviceEnergyModelContainer deviceModels = zigbeeEnergyHelper.Install (lrwpanDevices, sources);
  /***************************************************************************/
  ...
  ApplicationContainer apps = ping6.Install (nodes);
