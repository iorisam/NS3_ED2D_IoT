...
main (int argc, char *argv[])
{
  ...
  liionEnergyHelper.Set ("LiIonEnergySourceInitialEnergyJ", DoubleValue (100));
  // install source
  //EnergySourceContainer sources = basicSourceHelper.Install (c);
  /* device energy model */
  EnergySourceContainer sources = liionEnergyHelper.Install (c);
  ...
  // energy source
  Ptr<LiIonEnergySource> basicSourcePtr = DynamicCast<LiIonEnergySource> (sources.Get (1));
